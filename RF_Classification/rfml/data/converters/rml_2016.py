...
def load_GOLD_XYZ_OSC_dataset(path: str = None) -> Dataset:
    CACHE_PATH = "./iq_by_mod_snr.tar.bz2"
    REMOTE_URL = "http://opendata.deepsig.io/datasets/2016.10/RML2016.10a.tar.bz2"
    UNPICKLED_PATH = "iq_by_mod_snr.pkl"
    WARNING_MSG = "Trying to download GOLD_XYZ_OSC... this may be slow."
