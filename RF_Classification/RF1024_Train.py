...
print("Overall Validation Accuracy: {:.2f}%".format(final_accuracy))

# # Assume le is not used in rf1024 (not encoded), else load appropriately
# print("===============================")
# print("Running evaluation on validation set...")

# acc = compute_accuracy(model=model, data=val_dataset, le=None)
# acc_vs_snr, snr = compute_accuracy_on_cross_sections(
#     model=model, data=val_dataset, column="SNR"
# )
# cmn = compute_confusion(model=model, data=val_dataset)

# print("Overall Validation Accuracy: {:.4f}".format(acc))
# print("SNR (dB)\tAccuracy (%)")
# print("===============================")
# for a, s in zip(acc_vs_snr, snr):
#     print("{:d}\t{:0.1f}".format(s, a * 100))
# print("===============================")
